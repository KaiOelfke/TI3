/*
  ...
  Zeitrahmen stets abzuschlieﬂen. Es muss also garantiert werden, dass
...
implementieren Sie die Methoden anschlieﬂend.
*/
...
//Methode zur Ausgabe der Wartezeiten nach dem Ausf¸hren des Algorithmus
void printStats()
{
 printf("\n=============================================\n");
...
LINK deleteProcess(LINK current)
{
 //Update der Stats f¸r diesen Knoten 
 updateStats(current);
